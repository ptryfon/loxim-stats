...
public class LoximNode implements Node {
	...
	public ObjectValue getValue() throws SBQLException, DeletedException {
	...
	public void markAttached(LoximSession session, String ref) {
		this.ref = ref;
	...
	public void addChild(Node child) throws SBQLException, DeletedException {
		if (detached) {
...
//		markAsDeleted();
	...
	public Collection<Node> getAllChildNodes() throws SBQLException {
		if (detached) {
...
//		deleted = true;
//		
//		for (Node child : getAllChildNodes()) {
//			
//			((LoximNode)child).markAsDeleted();
//			
//		}
//	}
