#ifndef PROTOCOL_Q_S_EXECUTING_PACKAGE_H
#define PROTOCOL_Q_S_EXECUTING_PACKAGE_H
...
namespace Protocol {
	class QSExecutingPackage : public Package {
		private:
		public:
			QSExecutingPackage(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			QSExecutingPackage();
