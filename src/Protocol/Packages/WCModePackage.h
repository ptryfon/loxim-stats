#ifndef PROTOCOL_W_C_MODE_PACKAGE_H
#define PROTOCOL_W_C_MODE_PACKAGE_H
...
namespace Protocol {
	class WCModePackage : public Package {
		private:
			uint64_t new_mode;
		public:
			WCModePackage(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			WCModePackage(uint64_t new_mode);
			...
			uint64_t get_val_new_mode() const;
	};
}
#endif
