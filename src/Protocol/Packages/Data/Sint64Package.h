#ifndef PROTOCOL_SINT64_PACKAGE_H
#define PROTOCOL_SINT64_PACKAGE_H
...
namespace Protocol {
	class Sint64Package : public Package {
		private:
			int64_t value;
		public:
			Sint64Package(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			Sint64Package(int64_t value);
