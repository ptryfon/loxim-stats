#ifndef PROTOCOL_BOB_PACKAGE_H
#define PROTOCOL_BOB_PACKAGE_H
...
namespace Protocol {
	class BobPackage : public Package {
		...
		public:
			BobPackage(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			BobPackage(std::auto_ptr<ByteBuffer> value);
