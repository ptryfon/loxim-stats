#ifndef PROTOCOL_SINT8_PACKAGE_H
#define PROTOCOL_SINT8_PACKAGE_H
...
namespace Protocol {
	class Sint8Package : public Package {
		private:
			int8_t value;
		public:
			Sint8Package(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			Sint8Package(int8_t value);
