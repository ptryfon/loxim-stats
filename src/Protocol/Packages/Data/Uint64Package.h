#ifndef PROTOCOL_UINT64_PACKAGE_H
#define PROTOCOL_UINT64_PACKAGE_H
...
namespace Protocol {
	class Uint64Package : public Package {
		private:
			uint64_t value;
		public:
			Uint64Package(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			Uint64Package(uint64_t value);
