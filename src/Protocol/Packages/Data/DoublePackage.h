#ifndef PROTOCOL_DOUBLE_PACKAGE_H
#define PROTOCOL_DOUBLE_PACKAGE_H
...
namespace Protocol {
	class DoublePackage : public Package {
		private:
			double value;
		public:
			DoublePackage(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			DoublePackage(double value);
