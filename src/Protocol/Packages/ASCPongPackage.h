#ifndef PROTOCOL_A_SC_PONG_PACKAGE_H
#define PROTOCOL_A_SC_PONG_PACKAGE_H
...
namespace Protocol {
	class ASCPongPackage : public Package {
		private:
		public:
			ASCPongPackage(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			ASCPongPackage();
