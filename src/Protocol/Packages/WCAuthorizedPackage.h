#ifndef PROTOCOL_W_C_AUTHORIZED_PACKAGE_H
#define PROTOCOL_W_C_AUTHORIZED_PACKAGE_H
...
namespace Protocol {
	class WCAuthorizedPackage : public Package {
		private:
		public:
			WCAuthorizedPackage(const sigset_t &mask, const bool &cancel, size_t &length, DataStream &stream);
			WCAuthorizedPackage();
