...
public class LoXiMDatabaseMetaDataImpl implements LoXiMDatabaseMetaData {
	...
	public String getDriverName() throws SQLException {
		return LoXiMProperties.LoXiMDriverName;
	}
	...
	public int getJDBCMajorVersion() throws SQLException {
		return LoXiMProperties.JDBCVerMajor;
	}

	@Override
	public int getJDBCMinorVersion() throws SQLException {
		return LoXiMProperties.JDBCVerMinor;
	}
	...
	/**
	 * @return null - no stored procedures in LoXiM
	...
	public boolean isWrapperFor(Class<?> iface) throws SQLException {
		return LoXiMDatabaseMetaData.class.equals(iface);
	}
