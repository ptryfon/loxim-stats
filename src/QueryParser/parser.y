...
statement   : query semicolon_opt { *result=$1; }
		...
		| schemaExpImp semicolon_opt { *result = $1;} 
	    ;
...
schemaExpImp: EXPORT NAME {$$ = new SchemaExpImpNode($2, true);}
		| IMPORT NAME {$$ = new SchemaExpImpNode($2, false);}
		;
