...
public class LoXiMDriverImplTest {
	...
	private static final String DB_URL = "jdbc:loxim:students.mimuw.edu.pl/db";
	private static final String DB_URL_WITH_PORT = "jdbc:loxim:students.mimuw.edu.pl:1234/db";
	...
	public void testAcceptsURL() throws SQLException {
		String[] good = {DB_URL, "jdbc:loxim:students.mimuw.edu.pl:2000/db"};
	...
	public void testConnect() throws SQLException {
		...
		Connection con1 = driver.connect(DB_URL, info);
		assertTrue(con1.isValid(0));
		con1.close();
		Connection con2 = driver.connect(DB_URL_WITH_PORT, info);
	...
	public void testDriverManagerRegistered() throws Exception {
		...
		assertEquals(LoXiMDriverImpl.class, DriverManager.getDriver(DB_URL).getClass());
	}
