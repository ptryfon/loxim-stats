...
namespace Indexes
{
	...
	public:
		...
		int dropIndex(int sessionId, string indexName, QueryResult **result);
		int createIndex(int sessionId, string indexName, string indexedRootName, string indexedFieldName, Comparator* comp, QueryResult **result);
